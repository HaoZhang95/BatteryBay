...
class OnBoardingViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    let onBoardingPages: [OnboardingPage] = {
        let firstPage = OnboardingPage(title: "Easy To Use", subtitle: "With only one click, you can easily save the recycle spots your favourite list. Life never become easier!", animationName: "done")
        let secondPage = OnboardingPage(title: "Live responsiblly", subtitle: "Everything is now in your hand. Are you ready to explore it?", animationName: "enjoy")
    ...
    let skipBtn: OnBoardingButton = {
        let button = OnBoardingButton(type: .custom)
