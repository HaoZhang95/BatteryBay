...
class OnBoardingCell: UICollectionViewCell {
    ...
    fileprivate static func createAttributedText(firstString: String, secondString: String) -> NSAttributedString {
        ...
        let firstAttributedString = NSMutableAttributedString(string: firstString, attributes: [NSAttributedStringKey.font : UIFont.boldSystemFont(ofSize: 25), NSAttributedStringKey.foregroundColor : UIColor.tvShowCellTextColor()])
        firstAttributedString.append(NSMutableAttributedString(string: secondString, attributes: [NSAttributedStringKey.font : UIFont.boldSystemFont(ofSize: 15), NSAttributedStringKey.foregroundColor : UIColor.white]))
